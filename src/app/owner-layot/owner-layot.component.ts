...
@Component({
  selector: 'app-owner-layot',
  standalone: true,
  imports: [OwnerSidebarComponent, OwnerFooterComponent, RouterOutlet, OwnerHeaderComponent, OwnerHeaderComponent, RouterLink],
  templateUrl: './owner-layot.component.html',
  styleUrl: './owner-layot.component.css'
})
export class OwnerLayotComponent {
